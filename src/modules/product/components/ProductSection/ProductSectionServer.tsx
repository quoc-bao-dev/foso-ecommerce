...
interface ProductSectionServerProps {
  initialProducts: Product[];
}

const ProductSectionServer = ({
  initialProducts,
}: ProductSectionServerProps) => {
  ...
  const productsList = useMemo(() => {
    // Use initial products if no data from query yet
...
export default ProductSectionServer;
